...
import { getChauffeur } from "@/lib/actions/chauffeur-action";
                ...
                <div>
                  {data.map((car: ICar, index: number) => (
                    <div className="mt-4" key={index}>
                      <CarCard car={car} basePath="chauffeur" />
                    </div>
                  ))}
                  <Pagination
        ...
        <section className="w-full bg-white-lightSlate px-0 xl:px-5 2xl:px-0">
          <div className="md:pb-16 pb-6 mt-6 md:mt-24 mx-auto px-0">
            ...
            <div>
              {data?.length > 0 && (
                <div className="mt-4">
                  <CarDriverCard data={data} basePath="chauffeur" />
                </div>
              )}
            </div>
          </div>
