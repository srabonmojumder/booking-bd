...
const ExecutiveDrive = () => {
  ...
  const handleEnglishProficiencyChange = (
          ...
          <CardContent className="p-8 md:p-12">
            <div className="mb-10 text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Complete the application form below to be considered for the
                Executive Personal Driver position. All fields marked with an
                ...
                <div className="space-y-6 md:col-span-2">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label
                        htmlFor="firstName"
                        className="flex gap-1 text-gray-700 font-semibold"
                      >
                ...
                <div className="space-y-6 md:col-span-2">
                  ...
                  <div className="space-y-2">
                    <Label
                      ...
                      className="flex gap-1 text-gray-700 font-semibold"
                    >
                      Educational Qualification (Last one){" "}
                ...
                <div className="space-y-6 md:col-span-2">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div
                        className={`relative w-full h-40 border-2 border-dashed rounded-lg ${
                          isDragging
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            handleFileInput(e, setDrivingLicenseFile)
                          }
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <input
                          ...
                          className="absolute inset-0 w-full h-full opacity-0 cursor-pointer"
                          onChange={(e) =>
                            handleFileInput(e, setNationalIdFile)
                          }
                        />
                        <div className="flex flex-col items-center justify-center h-full space-y-3 p-4">
                          <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-start space-x-3 p-4 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-all cursor-pointer">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            I am fully fluent in business/technical
                            communication
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3 p-4 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-all cursor-pointer">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            I feel fairly confident communicating in English
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3 p-4 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-all cursor-pointer">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            I do not always feel comfortable communicating in
                            English
                          </p>
                        </div>
                      </div>
