...
import { getVisaBySlug } from "@/lib/actions/visa-action";
import VisaOverview from "@/components/visa/visaDetails/VisaOverview";
...
const VisaDetails = async ({ params, searchParams }: any) => {
    ...
    <div>
      ...
      <main className="w-[96%] sm:container m-auto min-h-screen  py-8  ">
        <div className="bg-white p-6 rounded-xl  ">
          <Link
            href={`/visa?${_searchParams.toString()}`}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-3">
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <span>{data?.working_day} Days</span>
                <span>|</span>
                <span className=" flex items-center ">
                  <MapPin className="h-5 w-5 pe-1" />
                  {data?.country?.name}
                </span>
              </div>
            </div>
          ...
          <RatingBadgeHorizontal
            total={Number(reviews?.total_review || 0)}
            score={Number(reviews?.score_total || 0)}
          />
        ...
        <div className="flex gap-8 w-full my-6 lg:flex-row flex-col-reverse" id={elId}>
          ...
          <div className="lg:w-[70%] w-full rounded-lg">
            <div className="w-full ">
              <Tabs defaultValue="overview" className="w-full font-bold">
                <ScrollArea>
          ...
          <div className="flex-1 lg:max-w-md w-full mx-auto">
            <Card className=" px-5 py-6 bg-white rounded-lg shadow-md">
              ...
              <CardContent className="p-0 sm:p-0 mt-4 px-0">
