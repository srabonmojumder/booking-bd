...
const UmrahDetails = async (context: { params: Promise<{ slug: string }>, searchParams: any }) => {
              ...
              <Tabs defaultValue="documents" className="w-full bg-[#f6f7fa] ">
                ...
                <ScrollArea className="w-full ">
                  ...
                  <TabsContent value="hotels" className="border-none space-y-2">
                    <UmrahHotel hotels={tabsData.hotel} hotelBed={tabsData?.hotel_bed} hotelServiceIncluding={tabsData?.hotel_service_including}  />
                  </TabsContent>
                  <ScrollBar orientation="horizontal" className="invisible" />
                </ScrollArea>
              </Tabs>
