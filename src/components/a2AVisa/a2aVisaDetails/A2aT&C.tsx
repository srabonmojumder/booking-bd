...
const A2aVisaTermsAndConditions = ({termsConditions}:any) => {
                ...
                <AccordionItem value="policies" className="border-0">
                    <AccordionTrigger className="px-6 py-4 hover:no-underline">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-lg leading-[26px] font-semibold">A2a Visa Terms & Conditions</span>
                        </div>
                    </AccordionTrigger>
...
export default A2aVisaTermsAndConditions