...
export default function UmrahFilter({attributes, params, baseUrl, priceRange}: {attributes: FilterAttribute[], params: any, baseUrl: string, priceRange?: number[]}) {
  return (
    <div className="w-full md:max-w-xs bg-white shadow-lg rounded-lg overflow-hidden">
