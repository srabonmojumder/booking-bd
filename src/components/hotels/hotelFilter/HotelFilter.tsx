...
const HotelFilter = ({attributes, params, baseUrl, priceRange}: {attributes: FilterAttribute[], params: any, baseUrl: string, priceRange?: number[]}) => {
  ...
  return (
    <div className="w-full lg:max-w-xs bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="divide-y divide-white-frosted">
        <RatingFilter name="star_rate[]" label="Hotel Star" params={params} baseUrl={baseUrl} />
